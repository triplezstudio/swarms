...
void doFrame(tz::App* app)
{
  ...
  for (int i = 0; i < 3; i++) {
    app->renderColoredQuad(Eigen::Vector3f(0 + i * 1.2, 0, 0));
  ...
  app->renderColoredQuad(Eigen::Vector3f(100, 100, 0.2), Eigen::Vector3f(48, 48, 1));
  ...
  app->renderColoredQuad(Eigen::Vector3f(24 + mover, 24, 0.2), Eigen::Vector3f(48, 48, 1));
